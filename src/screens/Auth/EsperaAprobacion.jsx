...
const STEPS = [
  {
    ...
    icon:     '✅',
    label:    'Cuenta creada',
    sublabel: 'Registro completado exitosamente',
  },
  {
    status:   'done',
    icon:     '✅',
    label:    'Datos recibidos',
    sublabel: 'Documentación enviada al equipo',
  },
  {
    status:   'active',
    icon:     '🔍',
    label:    'Verificando CMP en el Colegio Médico del Perú',
    sublabel: 'Validando número de colegiatura y habilitación',
  },
  {
    status:   'pending',
    icon:     '🚀',
    label:    'Activación de cuenta',
    sublabel: 'Acceso completo al panel médico',
  },
]

const TIPS = [
  { icon: '📸', text: 'Prepara tu foto de perfil profesional' },
  { icon: '📋', text: 'Ten a mano tu número CMP' },
  { icon: '🕐', text: 'Piensa en tu horario de atención disponible' },
]
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes ea-pulse   { 0%,100%{opacity:1} 50%{opacity:.35} }
        ...
        @keyframes ea-slide   { from{opacity:0;transform:translateY(10px)} to{opacity:1;transform:translateY(0)} }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          ...
          animation: 'ea-glow 3s ease infinite',
        }}>
          🕐
        </div>
        ...
        <div style={{ textAlign: 'center', animation: 'ea-slide 0.4s ease both' }}>
          <h1 style={{
            ...
            margin: '0 0 6px', letterSpacing: -0.3, lineHeight: 1.25,
          }}>
            Tu solicitud está siendo revisada
          </h1>
          <p style={{ fontSize: 13, color: C.gray500, margin: 0, lineHeight: 1.6 }}>
            Verificamos tu número de colegiatura ante el CMP.
        ...
        <div style={{
          ...
          {STEPS.map((step, i) => {
            ...
            const labelColor   = isDone ? C.gray900  : isActive ? C.gray900 : C.gray500
            ...
            return (
              <div key={i}>
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  ...
                  {/* Texto del paso */}
                  <div style={{ paddingTop: 6, paddingBottom: i < STEPS.length - 1 ? 0 : 0, flex: 1 }}>
                    <div style={{
                      fontSize: 13, fontWeight: isActive ? 800 : isDone ? 700 : 500,
                    ...
                    <div style={{
                      fontSize: 11, color: isPending ? C.gray300 : C.gray500,
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 13, fontWeight: 700, color: C.amberText, marginTop: 1 }}>
              1–2 días hábiles
            </div>
          </div>
        ...
        <div style={{
          ...
          animation: 'ea-slide 0.4s 0.25s ease both',
        }}>
          <button
