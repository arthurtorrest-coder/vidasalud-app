...
// Checkout v4 en el frontend (src/pages/Payment/index.jsx) — tanto para
// tarjeta como para Yape, ya que el Checkout captura ambos casos dentro de
// su propio widget y siempre entrega un token listo para cobrar. Por eso
// esta función ya no necesita crear tokens Yape por su cuenta (evitamos así
// el alcance PCI DSS de manejar número + código de aprobación nosotros).
